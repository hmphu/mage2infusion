...
class Url
{
    const LIST_URL_CONFIG_PATH = 'ark_infusion/author/list_url';
    const URL_PREFIX_CONFIG_PATH = 'ark_infusion/author/url_prefix';
    const URL_SUFFIX_CONFIG_PATH = 'ark_infusion/author/url_suffix';
    /**
     * url builder
     *
    ...
    public function getListUrl()
    {
        ...
        return $this->urlBuilder->getUrl('ark_infusion/author/index');
    }
    ...
    public function getAuthorUrl(Author $author)
    {
        ...
        return $this->urlBuilder->getUrl('ark_infusion/author/view', ['id' => $author->getId()]);
    }
}
