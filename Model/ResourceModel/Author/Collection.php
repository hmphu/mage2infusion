...
class Collection extends AbstractCollection
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'ark_infusion_author_collection';
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store_id')) {
            $this->getSelect()->join(
                ['store_table' => $this->getTable('ark_infusion_author_store')],
    ...
    public function addProductFilter($product)
    {
        ...
        if (!isset($this->_joinedFields['product'])) {
            $this->getSelect()->join(
                ['related_product' => $this->getTable('ark_infusion_author_product')],
    ...
    public function addCategoryFilter($category)
    {
        ...
        if (!isset($this->_joinedFields['category'])) {
            $this->getSelect()->join(
                ['related_category' => $this->getTable('ark_infusion_author_category')],
