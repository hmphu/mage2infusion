...
class Category extends Template {
    ...
    protected function _prepareLayout()
    {
        ...
        $pager->setNameInLayout('ark_infusion.author.view.category.pager');
        $pager->setPageVarName('p-category');
        $pager->setFragment('ark_infusion.author.view.category');
        $pager->setLimitVarName('l-category');
        $pager->setCollection($this->getCategoryCollection());
        $this->setChild('ark_infusion.author.view.category.pager', $pager);
    ...
    {
        return $this->getChildHtml('ark_infusion.author.view.category.pager');
    }
