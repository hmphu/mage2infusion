...
class ListAuthor extends Template
{
    ...
    public function isRssEnabled()
    {
        return
            ...
            $this->_scopeConfig->getValue('ark_infusion/author/rss', ScopeInterface::SCOPE_STORE);
    }
    ...
    protected function _prepareLayout()
    {
        ...
        $pager = $this->getLayout()->createBlock('Magento\Theme\Block\Html\Pager', 'ark_infusion.author.list.pager');
