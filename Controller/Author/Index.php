...
{
    const META_DESCRIPTION_CONFIG_PATH = 'ark_infusion/author/meta_description';
    const META_KEYWORDS_CONFIG_PATH = 'ark_infusion/author/meta_keywords';
    const BREADCRUMBS_CONFIG_PATH = 'ark_infusion/author/breadcrumbs';
