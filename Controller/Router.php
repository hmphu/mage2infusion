    ...
    public function match(RequestInterface $request)
    {
        if (!$this->dispatched) {
            ...
            $this->eventManager->dispatch(
                'ark_infusion_controller_router_match_before',
            ...
            $entities = [
                'author' => [
                    'prefix'        => $this->scopeConfig->getValue(
                        'ark_infusion/author/url_prefix',
                        ScopeInterface::SCOPE_STORES
                    ),
                    'suffix'        => $this->scopeConfig->getValue(
                        'ark_infusion/author/url_suffix',
                        ScopeInterface::SCOPE_STORES
                    ),
                    'list_key'      => $this->scopeConfig->getValue(
                        'ark_infusion/author/list_url',
                        ScopeInterface::SCOPE_STORES
                    ),
                    'list_action'   => 'index',
            ...
            foreach ($entities as $entity => $settings) {
                if ($settings['list_key']) {
                    if ($urlKey == $settings['list_key']) {
                        $request->setModuleName('ark_infusion')
