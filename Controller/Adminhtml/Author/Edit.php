...
class Edit extends AuthorController
{
    ...
    {
        return $this->_authorization->isAllowed('Ark_Infusion::author');
    }
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Ark_Infusion::author');
        ...
        $data = $this->backendSession->getData('ark_infusion_author_data', true);
        if (!empty($data)) {
            $author->setData($data);
        }
        return $resultPage;
