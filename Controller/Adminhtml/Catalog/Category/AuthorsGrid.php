...
class AuthorsGrid extends Category
{
    ...
    public function execute(){
        ...
        $authorsBlock = $resultLayout->getLayout()->getBlock('category.ark_infusion.author.grid');
        if ($authorsBlock) {
            $authorsBlock->setCategoryAuthors($this->getRequest()->getPost('category_ark_infusion_authors', null));
        }
        return $resultLayout;
    }
}
